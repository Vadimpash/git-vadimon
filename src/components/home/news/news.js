            ...
            <div className="wrapNews">
                <div className="firItemNews">
                    ...
                    <div className="firContent">
                        ...
                        <div className="firDate"><span><img src={Calendar} alt="First date"/>15 ФЕВРАЛЯ 2019</span>
                        </div>
                ...
                <div className="thiItemNews">
                    ...
                    <div className="thiContent">
                        ...
                        <div className="thiDate"><span><img src={Calendar} alt="Third date"/> 15 ФЕВРАЛЯ 2019</span>
                        </div>
                ...
                <div className="fouItemNews">
                    ...
                    <div className="fouContent">
                        ...
                        <div className="fouDate"><span><img src={Calendar} alt="Fourth date"/>25 АВГУСТА 2019</span>
                        </div>
                        <div className="fouText"><p>Уважаемые жители и гости города Бреста!
                            Наш медицинский центр поздравляет вас с 1000-летием нашего удивительного, яркого и
                            солнечного
                            города!
